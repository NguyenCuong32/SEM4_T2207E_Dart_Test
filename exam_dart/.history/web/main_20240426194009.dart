  ...
  void main() {
    HttpRequest.getString('order.json').then((String jsonContent) {
      ...
      List<Order> orders = orderJsons.map((orderJson) => Order(item: orderJson['Item'], itemName: orderJson['ItemName'], price: orderJson['Price'], currency: orderJson['Currency'], quantity: orderJson['Quantity'])).toList();
